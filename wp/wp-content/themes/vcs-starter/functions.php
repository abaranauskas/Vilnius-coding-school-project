...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
       ...
       wp_register_script('jquery', ASSETS_URL . '/assets/js/jquery-3.2.1.slim.min.js', array(''), '1.0', true);
       wp_register_script('slick', ASSETS_URL . '/assets/js/slick.min.js', array('jquery'), '1.0', true);
        wp_register_script('js_main', ASSETS_URL . '/assets/js/main.js', array('jquery', 'slick'), '1.0', true);
...
function theme_stylesheets(){
	...
	if( $styles_path ) {
		...
		wp_register_style('slick-css', ASSETS_URL . '/assets/css/slick.css', array(), false, 'all');

		wp_register_style('slick-theme-css', ASSETS_URL . '/assets/css/slick-theme.css', array('slick-css'), false, 'all');

		wp_register_style('style-css', ASSETS_URL . '/assets/css/style.css', array('slick-css', 'slick-theme-css'), false, 'all');
